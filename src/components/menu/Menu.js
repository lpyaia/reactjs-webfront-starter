...
const Menu = () => {
        ...
        menuItems.forEach((element) => {
            ...
            menu.push(
                <li className="menu-item">
                    <Link to={element.path} className={`menu-link ${hasChildren ? "menu-toggle" : ""}`}>
                        <i className={`menu-icon tf-icons ${element.icon}`}></i>
    ...
    return (
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul className="menu-inner py-1">{menuItems}</ul>
        </aside>
    );
};
